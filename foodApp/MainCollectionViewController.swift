...
class MainCollectionViewController: UICollectionViewController {
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "Cell", for: indexPath) as! CuisineCollectionViewCell
    
        let cuisine = cuisineData[indexPath.row]
        
        cell.nameLabel.text = "\(cuisine.name ?? "noname")"
        cell.imageView.image = #imageLiteral(resourceName: "meks1.jpg")
